                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = when {
                                        isRootAvailable && isShizukuActive -> stringResource(R.string.privileged_both_active)
                                        isRootAvailable -> stringResource(R.string.privileged_root_active)
                                        else -> stringResource(R.string.shizuku_active_banner_desc)
                                    },
